...
const Catalog = () => {
    ...
    const clearFilterProducts = () => setFilter(initFilter)
        ...
        <Helmet title='Sản phẩm'>
            <div className="catalog">
                <div className="catalog__filter" ref={filterRef}>
                    ...
                    <div className="catalog__filter__widget">
                        <div className="catalog__filter__widget__content">
                            <Button size="sm" onClick={clearFilterProducts}>Xóa bộ lọc</Button>
                            {/* <button onClick={clearFilterProducts}>Xóa bộ lọc</button> */}
                        </div>
                    </div>
